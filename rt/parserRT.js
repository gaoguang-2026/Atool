var parserRT = (function(){
	...
	var getGainianRank = function(rtTickets = workbook.getRTTicketsLeader()) {
		...
		rtRankData.setRankDataFromDate(new Date(), retArr);
		return retArr;
	};
	...
	var getRTEchelons = function() {
		...
		for (var i = 0; i < gaiNianArr.length; i ++) {
			var g = gaiNianArr[i];
			if(g[Configure.titleGainian.ticketNum] >= Configure.Echelons_show_min_rank_number /*&& 
				g[Configure.titleGainian.score] >= Configure.Echelons_show_min_score*/){ 
				var newEche = {};
